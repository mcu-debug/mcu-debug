...
This is needed for those who want to use the debugger in CLI mode and/or with AI. The prerequisite is [NodeJS v22+](https://nodejs.org) installed and in your system PATH.

Once Node.js is installed, you can set up the CLI tools directly within VS Code:

1. Open VS Code.
2. Open the Command Palette (`Cmd+Shift+P` / `Ctrl+Shift+P`).
3. Run the **MCU-Debug: Install CLI Tools** command.
4. Follow the prompt in the terminal to configure your shell profile PATH.
