...
fn render_help(frame: &mut ratatui::Frame) {
    ...
    let sent_test1 = "Send text (including newlines) to RTT/Serial port if there is only one";
    let sent_test2 = "Send text (including newlines) to the specified RTT/Serial port";
