        ...
        properties: {
            ...
            wslProxyPort: {
                ...
                description:
                    ...
                    "Windows Firewall blocks OS-assigned ports by default — set this to a port you have opened in Windows Firewall. " +
                    "The extension starts the Probe Agent with --port <N> --host 0.0.0.0 so the WSL guest can reach it via the gateway IP. " +
                    "Not needed for WSL Mirrored mode (Windows 11) where loopback is shared and no firewall rule is required. " +
