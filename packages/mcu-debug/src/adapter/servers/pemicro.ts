...
export class PEServerController extends EventEmitter implements GDBServerController {
    ...
    public launchCommands(): string[] {
        const commands = [...genDownloadCommands(this.args, ['interpreter-exec console "monitor _reset"']), 'interpreter-exec console "monitor _reset"'];
    ...
    public resetCommands(): string[] {
        const commands: string[] = ['interpreter-exec console "monitor _reset"'];
