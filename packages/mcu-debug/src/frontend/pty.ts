...
class ACTIONS {
    ...
    public static cursorUp(n = 1) {
        return n > 0 ? CSI + n.toString() + "A" : "";
    }
    public static cursorDown(n = 1) {
        return n > 0 ? CSI + n.toString() + "B" : "";
    }
    public static cursorForward(n = 1) {
        return n > 0 ? CSI + n.toString() + "C" : "";
    }
    public static cursorBack(n = 1) {
        return n > 0 ? CSI + n.toString() + "D" : "";
    }
    public static clearAll() {
        return CSI + "2J" + CSI + "3J" + CSI + ";H";
    } // Kill entire buffer and set cursor postion to 1,1
    public static clearScreen() {
        return CSI + "2J" + CSI + ";H";
    } // Kill the visible part of the screen
    public static deleteChar() {
        return CSI + "P";
    }
    public static deletePrevChar() {
        return ACTIONS.cursorBack() + ACTIONS.deleteChar();
    }
    public static deleteCurrChar() {
        return ACTIONS.deleteChar();
    }
    public static killLineForward() {
        return CSI + "K";
    }
    public static killLine(n = 0) {
        return ACTIONS.cursorBack(n) + ACTIONS.killLineForward();
    }
    public static killEntireLine() {
        return CSI + "2K";
    }
    /* eslint-enable */
}
...
export class PtyTerminal extends EventEmitter {
    ...
    protected promptTimer: ResettableTimeout | null = null;
    ...
    protected handleSpecialChars(chars: string): boolean {
        ...
        if (code === 27) {
            ...
            switch (chars[2]) {
                case "A": {
                    // UP: TODO: use for history
                    break;
                }
                case "B": {
                    // DOWN: TODO: use for history
                    break;
                }
                case "C": {
                    // RIGHT
            ...
            switch (chars) {
                ...
                case "H": {
                    // kill char left of cursor
                    this.killPrevChar();
                    break;
                }
                case "K": {
                    // Kill from current cursor (inclusive) to end of line
