 ...
 */
export type HelperEvent = { "type": "SymbolTableReady", session_id: string, version: string, } | { "type": "DisassemblyReady", session_id: string, instruction_count: bigint, } | { "type": "RTTFound", session_id: string, address: string, } | { "type": "Progress", session_id: string, operation: string, percentage: number | null, message: string | null, } | { "type": "Output", session_id: string, category: string, message: string, } | { "type": "Error", session_id: string, code: string | null, message: string, details: string | null, } | { "type": "Log", session_id: string, level: string, message: string, };
